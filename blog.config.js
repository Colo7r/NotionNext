...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hwa', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Ph.D Student', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://colo7r.com', // 网站地址
